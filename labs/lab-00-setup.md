...
Before checking the tools below, start Docker Desktop: double-click the **Docker Desktop** icon on your desktop and wait for it to finish starting (the whale icon in the system tray stops animating once it's ready).
